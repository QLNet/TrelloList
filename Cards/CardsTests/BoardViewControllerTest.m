...
@property (nonatomic,strong) BoardViewController *vc;
...
- (void)setUp {
    ...
    self.vc = [[BoardViewController alloc] initWithNibName:@"BoardViewController" bundle:nil];
